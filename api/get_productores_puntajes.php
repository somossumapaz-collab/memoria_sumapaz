...
try {
    ...
    $stmt = $pdo->query("SELECT id, nombre_completo, vereda, telefono, fecha_nacimiento, panaca, ferias, beneficiario_2026, nivel_priorizacion FROM productores_sumapaz");
    ...
    foreach ($caracterizaciones as $pid => $carac) {
        ...
        $results[] = [
            ...
            'nivel_priorizacion' => $p['nivel_priorizacion'] !== null ? intval($p['nivel_priorizacion']) : null,
